...
def make_wishes():
    print("Make wishes and mention your life's asperiation: ")
    aspiration = input()
...
def roll():
    ...
    if total_roll ==12:
        print("Today is your bad day.\nChill and relex in your room plz!")
    elif total_roll % 2 == 0:
        print("This is your lucky day. You will achieve your dream.")
    else:
        print("The luck is not favourable for you!")
